...
const CreatorDetail: FunctionComponent<Props> = ({ creator, classes }) => {
    return (
        ...
        <Row>
            ...
            <Row xs={2} md={4} lg={6}><Col><a href={creator.youtubeUrl} target="_blank" rel="noreferrer"><img style={{cursor:'pointer'}} src={creator.imageSrc}></img></a></Col><Col>{creator.description}</Col></Row>
